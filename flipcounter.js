...
var flipCounter = function(d, options){
   ...
   this.decrementTo = function(n, t, p){
      if (nextCount) clearNext();
      ...
      if (typeof t != 'undefined'){
         var time = isNumber(t) ? t * 1000 : 10000,
         pace = typeof p != 'undefined' && isNumber(p) ? p : o.pace,
         diff = typeof n != 'undefined' && isNumber(n) ? o.value - n : 0,
         cycles, inc, check, i = 0;
         best.q = null;
   ...
   function doDecrement(n, s, c){
      ...
      if (val != n){
         ...
         digitCheck(x,y);
         nextCount = setTimeout(function(){doDecrement(n, smart, cycles)}, o.pace);
      }
      else o.auto = false;
   }
